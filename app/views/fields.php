            ...
            <table class="form-table table table-striped">
                ...
                <?php foreach ($this->get_option('fields') as $key=>$field) : ?>
                    <tr valign="top">
                        ...
                        <td>
                            <input class="checkSelector" type="checkbox" name="csv-to-db[fields][<?php echo $key; ?>][check]" value="1" <?php echo $field['check']==1 ? 'checked="checked"' : ''; ?> onchange="checkOtherCheckboxes(<?php echo $key; ?>)" />
                        </td>
                    </tr>
                <?php endforeach; ?>
            </table>
